...
class AppShell(Pmw.MegaWidget):         
	...
	def __initializeTk_win32(self, root):
		...
		root.option_add('*EntryField.Entry.Font', 'Arial 8')
		root.option_add('*Listbox*Font', 'Arial 8')
	...
	def __createMenuBar(self):
		...
		self.menuBar.addmenu('File', 'File Functions')
